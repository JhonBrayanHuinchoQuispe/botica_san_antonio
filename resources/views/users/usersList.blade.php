                ...
                <div class="card-body p-6">
                        ...
                        <table class="table bordered-table sm-table mb-0">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td class="text-center">
                                        <span class="bg-neutral-200 text-neutral-600 border border-neutral-400 px-6 py-1.5 rounded font-medium text-sm">Inactive</span>
                                    </td>
                                    <td class="text-center">
                                        <div class="flex items-center gap-3 justify-center">
                                            <button type="button"
                    ...
                    <div class="flex items-center justify-between flex-wrap gap-2 mt-6">
                        ...
                        <ul class="pagination flex flex-wrap items-center gap-2 justify-center">
                            ...
                            <li class="page-item">
                                <a class="page-link bg-neutral-300 text-secondary-light font-semibold rounded-lg border-0 flex items-center justify-center h-8 w-8"
