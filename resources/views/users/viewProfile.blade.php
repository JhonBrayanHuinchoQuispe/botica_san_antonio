                ...
                <div class="card-body p-6">
                    ...
                    <div id="default-tab-content">
                        <div class="hidden" id="edit-profile" role="tabpanel" aria-labelledby="edit-profile-tab">
                            ...
                            <div class="mb-6 mt-4">
                                <div class="avatar-upload">
                                    <div class="avatar-edit absolute bottom-0 end-0 me-6 mt-4 z-[1] cursor-pointer">
                                        ...
                                        <label for="imageUpload" class="w-8 h-8 flex justify-center items-center bg-primary-100 text-primary-600 border border-primary-600 hover:bg-primary-100 text-lg rounded-full">
                            ...
                            <form action="#">
                                <div class="grid grid-cols-1 sm:grid-cols-12 gap-x-6">
                                    ...
                                    <div class="col-span-12 sm:col-span-6">
                                        <div class="mb-5">
                                            <label for="Language" class="inline-block font-semibold text-neutral-600 text-sm mb-2">Language <span class="text-danger-600">*</span> </label>
                        ...
                        <div class="hidden" id="change-password" role="tabpanel" aria-labelledby="change-password-tab">
                            <div class="mb-5">
                                <label for="your-password" class="inline-block font-semibold text-neutral-600 text-sm mb-2">New Password <span class="text-danger-600">*</span></label>
                                <div class="relative">
                            ...
                            <div class="mb-5">
                                <label for="confirm-password" class="inline-block font-semibold text-neutral-600 text-sm mb-2">Confirmed Password <span class="text-danger-600">*</span></label>
                                <div class="relative">
